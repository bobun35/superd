...
var author$project$BudgetMuv$Model = F2(
	function (current, modal) {
		return {current: current, modal: modal};
	});
var author$project$BudgetMuv$NoBudget = {$: 'NoBudget'};
var author$project$BudgetMuv$NoModal = {$: 'NoModal'};
var author$project$BudgetMuv$initModel = A2(author$project$BudgetMuv$Model, author$project$BudgetMuv$NoBudget, author$project$BudgetMuv$NoModal);
...
var author$project$Main$initBudgets = _List_Nil;
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		var emptyModel = author$project$Main$Model(
			elm$core$Maybe$Just(key))(url)(author$project$Main$LoginPage)('claire@superd.net')('pass123')('')(author$project$Main$initSchool)(author$project$Main$initBudgets)(author$project$Main$initUser)(author$project$OperationMuv$initModel)(author$project$BudgetMuv$initModel);
		if (flags.$ === 'Just') {
		...
		switch (msg.$) {
			...
			case 'ModifyClicked':
				return _Utils_Tuple3(
					_Utils_update(
						model,
						{modal: author$project$BudgetMuv$ModifyModal}),
					author$project$BudgetMuv$NoNotification,
					elm$core$Platform$Cmd$none);
			case 'SaveClicked':
				...
				switch (_n1.$) {
					case 'Validated':
						var existingBudget = _n1.a;
						var updatedBudget = author$project$BudgetMuv$Update(
							{id: existingBudget.id, info: existingBudget.info});
						return _Utils_Tuple3(
							_Utils_update(
								model,
			...
			case 'AddClicked':
				return _Utils_Tuple3(
					_Utils_update(
						model,
						{
							current: author$project$BudgetMuv$Create(author$project$BudgetMuv$emptyInfo),
							modal: author$project$BudgetMuv$CreateModal
						}),
					author$project$BudgetMuv$NoNotification,
					elm$core$Platform$Cmd$none);
			case 'SetName':
...
var author$project$Main$GotBudgetMsg = function (a) {
	return {$: 'GotBudgetMsg', a: a};
};
...
var author$project$Main$ApiPostOrPutOrDeleteOperationResponse = function (a) {
	return {$: 'ApiPostOrPutOrDeleteOperationResponse', a: a};
};
...
var author$project$OperationMuv$idEncoder = function (operation) {
...
var author$project$Main$apiDeleteOperation = F3(
	function (token, budgetId, operation) {
		var body = elm$http$Http$jsonBody(
			author$project$OperationMuv$idEncoder(operation));
		return A2(
...
var author$project$BudgetMuv$ExistingBudget = F5(
	function (id, info, realRemaining, virtualRemaining, operations) {
		return {id: id, info: info, operations: operations, realRemaining: realRemaining, virtualRemaining: virtualRemaining};
	});
...
var author$project$OperationMuv$AmountField = F2(
	function (value, stringValue) {
		return {stringValue: stringValue, value: value};
	});
...
var author$project$OperationMuv$amountFieldDecoder = function (maybeAmount) {
	var _n0 = author$project$OperationMuv$centsToEuros(maybeAmount);
	if (_n0.$ === 'Just') {
		var amount = _n0.a;
		return elm$json$Json$Decode$succeed(
			A2(
		...
		return elm$json$Json$Decode$succeed(
			A2(author$project$OperationMuv$AmountField, elm$core$Maybe$Nothing, ''));
	}
};
...
var author$project$OperationMuv$amountDecoder = A2(
	elm$json$Json$Decode$andThen,
	author$project$OperationMuv$amountFieldDecoder,
	elm$json$Json$Decode$nullable(elm$json$Json$Decode$int));
var author$project$OperationMuv$toDateString = F3(
...
var author$project$OperationMuv$dateDecoder = A3(
...
var author$project$OperationMuv$Content = F5(
...
var author$project$OperationMuv$Validated = F2(
	function (a, b) {
		return {$: 'Validated', a: a, b: b};
	});
var author$project$OperationMuv$toDecoder = function (id) {
	return function (name) {
									...
									return function (amount) {
										...
										return elm$json$Json$Decode$succeed(
											A2(
												...
												id,
												A5(author$project$OperationMuv$Content, name, store, comment, quotation, invoice)));
									};
								};
							};
						};
...
var author$project$OperationMuv$operationDecoder = NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$resolve(
	A2(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
		A2(elm$json$Json$Decode$field, 'invoiceAmount', author$project$OperationMuv$amountDecoder),
		A4(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
			'invoiceDate',
			elm$json$Json$Decode$nullable(author$project$OperationMuv$dateDecoder),
			elm$core$Maybe$Nothing,
			A4(
				NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
				'invoice',
				...
				A2(
					NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
					A2(elm$json$Json$Decode$field, 'quotationAmount', author$project$OperationMuv$amountDecoder),
					A4(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
						'quotationDate',
						elm$json$Json$Decode$nullable(author$project$OperationMuv$dateDecoder),
								...
								A3(
									...
									A3(
										...
										A3(
											...
											'id',
											elm$json$Json$Decode$int,
											elm$json$Json$Decode$succeed(author$project$OperationMuv$toDecoder))))))))))));
...
var author$project$BudgetMuv$budgetDetailDecoder = NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$resolve(
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'operations',
		elm$json$Json$Decode$list(author$project$OperationMuv$operationDecoder),
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'virtualRemaining',
			...
			A3(
				...
				A3(
					NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
					'comment',
					A2(elm_community$json_extra$Json$Decode$Extra$withDefault, '', elm$json$Json$Decode$string),
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'creditor',
						elm$json$Json$Decode$string,
			...
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'name',
						elm$json$Json$Encode$string(content.name)),
						_Utils_Tuple2(
						'store',
						elm$json$Json$Encode$string(content.store)),
						_Utils_Tuple2(
						'comment',
						author$project$OperationMuv$encodeMaybeString(content.comment)),
						_Utils_Tuple2(
						'quotation',
						author$project$OperationMuv$encodeMaybeString(content.quotation.reference)),
						_Utils_Tuple2(
						'quotationDate',
						author$project$OperationMuv$encodeMaybeString(content.quotation.date)),
						_Utils_Tuple2(
						'quotationAmount',
						author$project$OperationMuv$encodeAmount(content.quotation.amount)),
						_Utils_Tuple2(
						'invoice',
						author$project$OperationMuv$encodeMaybeString(content.invoice.reference)),
						_Utils_Tuple2(
						'invoiceDate',
						author$project$OperationMuv$encodeMaybeString(content.invoice.date)),
						_Utils_Tuple2(
						'invoiceAmount',
						author$project$OperationMuv$encodeAmount(content.invoice.amount))
					]));
		case 'Create':
			var content = operation.a;
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
...
var author$project$Main$apiPutOperation = F3(
	function (token, budgetId, operation) {
		return A4(author$project$Main$apiPostorPutOperation, 'PUT', token, budgetId, operation);
	});
...
var author$project$OperationMuv$Create = function (a) {
	return {$: 'Create', a: a};
};
var author$project$OperationMuv$CreateModal = {$: 'CreateModal'};
var author$project$OperationMuv$IdOnly = function (a) {
	return {$: 'IdOnly', a: a};
};
var author$project$OperationMuv$ModifyModal = {$: 'ModifyModal'};
var author$project$OperationMuv$NoNotification = {$: 'NoNotification'};
var author$project$OperationMuv$ReadOnlyModal = {$: 'ReadOnlyModal'};
var author$project$OperationMuv$SendDeleteRequest = function (a) {
	return {$: 'SendDeleteRequest', a: a};
};
var author$project$OperationMuv$SendPostRequest = function (a) {
	return {$: 'SendPostRequest', a: a};
};
...
var author$project$OperationMuv$emptyAccountingEntry = A3(
	author$project$OperationMuv$AccountingEntry,
	elm$core$Maybe$Nothing,
	elm$core$Maybe$Nothing,
	A2(author$project$OperationMuv$AmountField, elm$core$Maybe$Nothing, ''));
var author$project$OperationMuv$emptyContent = A5(author$project$OperationMuv$Content, '', '', elm$core$Maybe$Nothing, author$project$OperationMuv$emptyAccountingEntry, author$project$OperationMuv$emptyAccountingEntry);
var elm$core$String$toFloat = _String_toFloat;
var author$project$OperationMuv$updateAccountingEntry = F3(
	function (accountingEntry, field, value) {
		switch (field) {
			case 'reference':
				return _Utils_update(
					accountingEntry,
			...
			case 'amount':
				var _n1 = elm$core$String$toFloat(value);
				if (_n1.$ === 'Just') {
					var amount = _n1.a;
					return _Utils_update(
						accountingEntry,
				...
				return _Utils_Tuple3(
					_Utils_update(
						model,
						{
							...
							modal: author$project$OperationMuv$ReadOnlyModal
						}),
				...
				return _Utils_Tuple3(
					_Utils_update(
						model,
						{
							...
							modal: author$project$OperationMuv$ModifyModal
						}),
					author$project$OperationMuv$NoNotification,
					elm$core$Platform$Cmd$none);
			case 'SaveClicked':
					...
					case 'Validated':
						...
						return _Utils_Tuple3(
							...
							author$project$OperationMuv$SendPutRequest(
								A2(author$project$OperationMuv$Validated, id, operation)),
							elm$core$Platform$Cmd$none);
					case 'Create':
						var content = _n1.a;
						return _Utils_Tuple3(
							_Utils_update(
								model,
								{current: author$project$OperationMuv$NoOperation, modal: author$project$OperationMuv$NoModal}),
							author$project$OperationMuv$SendPostRequest(
								author$project$OperationMuv$Create(content)),
							elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple3(
							_Utils_update(
			...
			case 'AddClicked':
				return _Utils_Tuple3(
					_Utils_update(
						model,
						{
							current: author$project$OperationMuv$Create(author$project$OperationMuv$emptyContent),
							modal: author$project$OperationMuv$CreateModal
						}),
					author$project$OperationMuv$NoNotification,
					elm$core$Platform$Cmd$none);
			case 'DeleteClicked':
				...
				if (_n2.$ === 'Validated') {
					...
					return _Utils_Tuple3(
						_Utils_update(
							model,
							{current: author$project$OperationMuv$NoOperation, modal: author$project$OperationMuv$NoModal}),
						author$project$OperationMuv$SendDeleteRequest(
							A2(author$project$OperationMuv$Validated, id, operation)),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple3(
					...
					case 'Create':
						...
						return _Utils_Tuple3(
							_Utils_update(
								model,
								{
									current: author$project$OperationMuv$Create(newContent)
								}),
							author$project$OperationMuv$NoNotification,
							elm$core$Platform$Cmd$none);
					default:
			...
			case 'SetQuotationReference':
				...
				switch (_n4.$) {
					case 'Validated':
						var id = _n4.a;
						var content = _n4.b;
						var newQuotation = A3(author$project$OperationMuv$updateAccountingEntry, content.quotation, 'reference', value);
						var newContent = _Utils_update(
							content,
			...
			case 'SetQuotationDate':
				...
				switch (_n5.$) {
					case 'Validated':
						var id = _n5.a;
						var content = _n5.b;
						var newQuotation = A3(author$project$OperationMuv$updateAccountingEntry, content.quotation, 'date', value);
						var newContent = _Utils_update(
							content,
							{quotation: newQuotation});
						return _Utils_Tuple3(
			...
			case 'SetQuotationAmount':
				...
				switch (_n6.$) {
					case 'Validated':
						var id = _n6.a;
						var content = _n6.b;
						var newQuotation = A3(author$project$OperationMuv$updateAccountingEntry, content.quotation, 'amount', value);
						var newContent = _Utils_update(
							content,
							{quotation: newQuotation});
						return _Utils_Tuple3(
			...
			case 'SetInvoiceReference':
				...
				switch (_n7.$) {
					case 'Validated':
						var id = _n7.a;
						var content = _n7.b;
						var newInvoice = A3(author$project$OperationMuv$updateAccountingEntry, content.invoice, 'reference', value);
						var newContent = _Utils_update(
							content,
							{invoice: newInvoice});
						return _Utils_Tuple3(
			...
			case 'SetInvoiceDate':
				...
				switch (_n8.$) {
					case 'Validated':
						var id = _n8.a;
						var content = _n8.b;
						var newInvoice = A3(author$project$OperationMuv$updateAccountingEntry, content.invoice, 'date', value);
						var newContent = _Utils_update(
							content,
							{invoice: newInvoice});
						return _Utils_Tuple3(
			...
			case 'SetInvoiceAmount':
				...
				switch (_n9.$) {
					case 'Validated':
						var id = _n9.a;
						var content = _n9.b;
						var newInvoice = A3(author$project$OperationMuv$updateAccountingEntry, content.invoice, 'amount', value);
						var newContent = _Utils_update(
							content,
							{invoice: newInvoice});
						return _Utils_Tuple3(
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				...
				return _Utils_Tuple2(
					newModel,
					author$project$Main$triggerOnLoadAction(newModel));
			case 'SetEmailInModel':
				var email = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'GotBudgetMsg':
				var subMsg = msg.a;
				var _n6 = A2(author$project$BudgetMuv$update, subMsg, model.currentBudget);
				var subModel = _n6.a;
				var notification = _n6.b;
				var subCmd = _n6.c;
				switch (notification.$) {
					case 'SendPutRequest':
					...
					default:
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{currentBudget: subModel}),
							A2(elm$core$Platform$Cmd$map, author$project$Main$GotBudgetMsg, subCmd));
				}
				...
				switch (responseData.$) {
					case 'Success':
						...
						var newCmd = author$project$BudgetMuv$isValid(newSubModel) ? A2(
							author$project$Main$pushUrl,
							model,
							author$project$Constants$hashed(author$project$Constants$budgetOperationUrl)) : A2(
							author$project$Main$pushUrl,
							model,
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{currentBudget: newSubModel}),
							newCmd);
					case 'Failure':
						var httpError = responseData.a;
						return A2(author$project$Main$httpErrorHelper, model, httpError);
					default:
						var _n9 = A2(elm$core$Debug$log, 'getBudgetHasFailed, responseData', responseData);
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'GotOperationMsg':
				var subMsg = msg.a;
				var maybeBudgetId = author$project$BudgetMuv$getId(model.currentBudget);
				var _n10 = A2(author$project$OperationMuv$update, subMsg, model.currentOperation);
				var subModel = _n10.a;
				var notification = _n10.b;
				var subCmd = _n10.c;
				var _n11 = _Utils_Tuple2(notification, maybeBudgetId);
				_n11$3:
				while (true) {
					if (_n11.b.$ === 'Just') {
						switch (_n11.a.$) {
							case 'SendPutRequest':
								var operation = _n11.a.a;
								var budgetId = _n11.b.a;
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{currentOperation: subModel}),
									A3(author$project$Main$apiPutOperation, model.token, budgetId, operation));
							case 'SendPostRequest':
								var operation = _n11.a.a;
								var budgetId = _n11.b.a;
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{currentOperation: subModel}),
									A3(author$project$Main$apiPostOperation, model.token, budgetId, operation));
							case 'SendDeleteRequest':
								var operation = _n11.a.a;
								var budgetId = _n11.b.a;
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{currentOperation: subModel}),
									A3(author$project$Main$apiDeleteOperation, model.token, budgetId, operation));
							default:
								break _n11$3;
						}
					} else {
			...
			default:
				...
				switch (responseData.$) {
					case 'Success':
						var maybeBudgetId = author$project$BudgetMuv$getId(model.currentBudget);
						if (maybeBudgetId.$ === 'Just') {
							var budgetId = maybeBudgetId.a;
							return _Utils_Tuple2(
								model,
								elm$core$Platform$Cmd$batch(
									_List_fromArray(
					...
					case 'Failure':
						...
						return A2(author$project$Main$httpErrorHelper, model, httpError);
					default:
						var _n14 = A2(elm$core$Debug$log, 'put or post OperationHasFailed, responseData', responseData);
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
		}
	});
...
var author$project$BudgetMuv$getName = function (model) {
	var _n0 = model.current;
	if (_n0.$ === 'Validated') {
		var existingBudget = _n0.a;
		return elm$core$Maybe$Just(existingBudget.info.name);
	} else {
		return elm$core$Maybe$Nothing;
	}
};
var author$project$BudgetMuv$getRealRemaining = function (model) {
	var _n0 = model.current;
	if (_n0.$ === 'Validated') {
		var existingBudget = _n0.a;
		return elm$core$Maybe$Just(existingBudget.realRemaining);
	} else {
		return elm$core$Maybe$Nothing;
	}
};
var author$project$BudgetMuv$getVirtualRemaining = function (model) {
	var _n0 = model.current;
	if (_n0.$ === 'Validated') {
		var existingBudget = _n0.a;
		return elm$core$Maybe$Just(existingBudget.virtualRemaining);
	} else {
		return elm$core$Maybe$Nothing;
	}
};
var author$project$Main$amountToStringHelper = function (amount) {
	if (amount.$ === 'Nothing') {
		return 'unavailable';
	} else {
		var value = amount.a;
...
var author$project$Main$viewBudgetAmounts = function (budget) {
	var virtual = author$project$Main$amountToStringHelper(
		author$project$BudgetMuv$getVirtualRemaining(budget));
	var real = author$project$Main$amountToStringHelper(
		author$project$BudgetMuv$getRealRemaining(budget));
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('budget disponible: ' + real)
							])),
						A2(
						elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								elm$html$Html$text('budget après engagement: ' + virtual)
							]))
					]))
			]));
};
...
var author$project$Main$viewBudgetTabs = function (tabType) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Main$viewErrorMessage = A2(
	elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var author$project$BudgetMuv$getOperations = function (model) {
	var _n0 = model.current;
	if (_n0.$ === 'Validated') {
		var existingBudget = _n0.a;
		return existingBudget.operations;
	} else {
		return _List_Nil;
	}
};
...
var author$project$BudgetMuv$viewInfoRow = F2(
...
var author$project$BudgetMuv$viewInfoRows = function (info) {
	return A2(
		elm$html$Html$tbody,
		_List_Nil,
		_List_fromArray(
			[
				A2(author$project$BudgetMuv$viewInfoRow, 'famille du budget', info.budgetType),
				A2(author$project$BudgetMuv$viewInfoRow, 'référence comptable', info.reference),
				A2(author$project$BudgetMuv$viewInfoRow, 'type du budget', info.creditor),
				A2(author$project$BudgetMuv$viewInfoRow, 'bénéficiaire', info.recipient),
...
var author$project$OperationMuv$viewAddButton = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('button is-rounded is-hovered is-pulled-right is-plus-button'),
			elm$html$Html$Events$onClick(author$project$OperationMuv$AddClicked)
		]),
	_List_fromArray(
		[
			A2(
...
var author$project$OperationMuv$viewOperationBody = F2(
	function (content, modal) {
		switch (modal.$) {
			case 'ReadOnlyModal':
				return A2(author$project$OperationMuv$viewOperationFields, content, author$project$OperationMuv$viewOperationReadOnly);
			case 'ModifyModal':
				return A2(author$project$OperationMuv$viewOperationFields, content, author$project$OperationMuv$viewOperationInput);
			case 'CreateModal':
				return A2(author$project$OperationMuv$viewOperationFields, content, author$project$OperationMuv$viewOperationInput);
			default:
...
var author$project$OperationMuv$CloseModalClicked = {$: 'CloseModalClicked'};
var author$project$OperationMuv$SaveClicked = {$: 'SaveClicked'};
var author$project$OperationMuv$cancelButton = F2(
	function (label, actionOnClick) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
...
var author$project$OperationMuv$successButton = F2(
	function (label, actionOnClick) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
...
var author$project$OperationMuv$modalSaveAndCancelButtons = _List_fromArray(
	[
		A2(author$project$OperationMuv$successButton, 'Enregistrer', author$project$OperationMuv$SaveClicked),
		A2(author$project$OperationMuv$cancelButton, 'Annuler', author$project$OperationMuv$CloseModalClicked)
	]);
var author$project$OperationMuv$DeleteClicked = {$: 'DeleteClicked'};
var author$project$OperationMuv$deleteButton = F2(
	function (label, actionOnClick) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('button is-danger is-outlined'),
					elm$html$Html$Events$onClick(actionOnClick)
				]),
			_List_fromArray(
				[
...
var author$project$OperationMuv$modalSaveCancelDeleteButtons = _List_fromArray(
	[
		A2(author$project$OperationMuv$successButton, 'Enregistrer', author$project$OperationMuv$SaveClicked),
		A2(author$project$OperationMuv$cancelButton, 'Annuler', author$project$OperationMuv$CloseModalClicked),
		A2(author$project$OperationMuv$deleteButton, 'Supprimer', author$project$OperationMuv$DeleteClicked)
	]);
var author$project$OperationMuv$viewOperationFooter = function (modal) {
	switch (modal.$) {
		case 'ModifyModal':
			return author$project$OperationMuv$modalSaveCancelDeleteButtons;
		case 'CreateModal':
			return author$project$OperationMuv$modalSaveAndCancelButtons;
		default:
			return _List_fromArray(
				[author$project$OperationMuv$emptyDiv]);
	}
};
var author$project$OperationMuv$ModifyClicked = F2(
	function (a, b) {
		return {$: 'ModifyClicked', a: a, b: b};
	});
var author$project$OperationMuv$viewOperationHeader = F3(
	function (maybeId, content, modal) {
		var _n0 = _Utils_Tuple2(modal, maybeId);
		if ((_n0.a.$ === 'ReadOnlyModal') && (_n0.b.$ === 'Just')) {
			var _n1 = _n0.a;
			var id = _n0.b.a;
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(content.name)
						])),
					A2(
					elm$html$Html$button,
					_List_fromArray(
						[
							...
							A2(author$project$OperationMuv$ModifyClicked, id, content))
						]),
					_List_fromArray(
						[
							A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							A3(author$project$OperationMuv$viewOperationHeader, maybeId, content, modal)),
							A2(
							elm$html$Html$section,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2(author$project$OperationMuv$viewOperationBody, content, modal)
										]))
								])),
							A2(
							elm$html$Html$footer,
							...
							author$project$OperationMuv$viewOperationFooter(modal))
						]))
				]));
	});
var author$project$OperationMuv$isSearchedOperation = F2(
	function (operationId, element) {
		if (element.$ === 'Validated') {
			var id = element.a;
			var content = element.b;
			return _Utils_eq(id, operationId) ? elm$core$Maybe$Just(
				_Utils_Tuple2(id, content)) : elm$core$Maybe$Nothing;
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
...
var author$project$OperationMuv$getOperationById = F2(
	function (operationId, operations) {
		return elm$core$List$head(
			A2(
				...
				A2(
					elm$core$List$filterMap,
					author$project$OperationMuv$isSearchedOperation(operationId),
					operations)));
	});
					...
					case 'IdOnly':
						if (_n0.a.$ === 'NoModal') {
							...
							if (operationToDisplay.$ === 'Just') {
								...
								return A3(
									author$project$OperationMuv$displayOperationModal,
									elm$core$Maybe$Just(id),
									operation,
									author$project$OperationMuv$ReadOnlyModal);
							} else {
								return author$project$OperationMuv$emptyDiv;
							}
						}
					case 'Validated':
						if (_n0.a.$ === 'NoModal') {
							...
							return A3(
								...
								elm$core$Maybe$Just(id),
								operation,
								author$project$OperationMuv$ModifyModal);
						}
					case 'Create':
						switch (_n0.a.$) {
							case 'NoModal':
							...
							case 'CreateModal':
								var _n4 = _n0.a;
								var content = _n0.b.a;
								return A3(author$project$OperationMuv$displayOperationModal, elm$core$Maybe$Nothing, content, author$project$OperationMuv$CreateModal);
							default:
								break _n0$4;
						}
					default:
...
var author$project$OperationMuv$viewOperationsHeaderRow = function () {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				elm$html$Html$tr,
				_List_Nil,
				A2(elm$core$List$map, author$project$OperationMuv$viewOperationsHeaderCell, columnNames))
			]));
}();
var author$project$OperationMuv$SelectClicked = function (a) {
	return {$: 'SelectClicked', a: a};
};
var author$project$OperationMuv$viewOperationsRow = function (operation) {
	if (operation.$ === 'Validated') {
		var id = operation.a;
		var content = operation.b;
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Events$onClick(
					author$project$OperationMuv$SelectClicked(id))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							A2(elm$core$Maybe$withDefault, '', content.quotation.reference))
						])),
					A2(
					elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text(
							A2(elm$core$Maybe$withDefault, '', content.quotation.date))
						])),
					A2(
					elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text(content.quotation.amount.stringValue)
						])),
					A2(
					elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text(
							A2(elm$core$Maybe$withDefault, '', content.invoice.reference))
						])),
					A2(
					elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text(
							A2(elm$core$Maybe$withDefault, '', content.invoice.date))
						])),
					A2(
					elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text(content.invoice.amount.stringValue)
						])),
					A2(
					elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text(content.store)
						])),
					A2(
					elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text(
							A2(elm$core$Maybe$withDefault, '', content.comment))
						]))
				]));
	} else {
		return author$project$OperationMuv$emptyDiv;
...
var author$project$OperationMuv$viewOperationsRows = function (operations) {
	return A2(
		elm$html$Html$tbody,
		_List_Nil,
		A2(elm$core$List$map, author$project$OperationMuv$viewOperationsRow, operations));
};
var author$project$OperationMuv$viewOperations = F2(
	function (operations, operationModel) {
		return A2(
			elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							author$project$OperationMuv$viewOperationsHeaderRow,
							author$project$OperationMuv$viewOperationsRows(operations)
						])),
					A2(author$project$OperationMuv$viewOperationModal, operations, operationModel)
				]));
	});
var author$project$Main$viewTabContent = F3(
	function (budget, tabType, currentOperation) {
		if (tabType.$ === 'OperationsTab') {
			var operations = author$project$BudgetMuv$getOperations(budget);
			return A2(
				elm$html$Html$map,
				author$project$Main$GotOperationMsg,
				A2(author$project$OperationMuv$viewOperations, operations, currentOperation));
		} else {
			return A2(
				elm$html$Html$map,
				author$project$Main$GotBudgetMsg,
				author$project$BudgetMuv$viewInfo(budget));
		}
	});
var author$project$Main$viewBudget = F2(
	function (model, tabType) {
		return (!author$project$BudgetMuv$isValid(model.currentBudget)) ? author$project$Main$viewErrorMessage : A2(
			elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
									...
									_List_fromArray(
										[
											...
											A2(
												elm$core$Maybe$withDefault,
												'Error',
												author$project$BudgetMuv$getName(model.currentBudget)))
										])),
									author$project$Main$viewBudgetAmounts(model.currentBudget)
								])),
							A2(
							elm$html$Html$div,
							_List_fromArray(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													author$project$Main$viewBudgetTabs(tabType)
												])),
											A2(
											elm$html$Html$div,
											_List_fromArray(
											...
											_List_fromArray(
												[
													A3(author$project$Main$viewTabContent, model.currentBudget, tabType, model.currentOperation)
												]))
										]))
								]))
						]))
...
var author$project$Main$SelectBudgetClicked = function (a) {
	return {$: 'SelectBudgetClicked', a: a};
};
...
var author$project$Main$viewLoginSubmitButton = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('has-text-centered')
		...
		[
			...
			_List_fromArray(
				[
					...
					elm$html$Html$Events$onClick(author$project$Main$LoginButtonClicked)
				]),
			_List_fromArray(
				[
...
var author$project$Main$SetPasswordInModel = function (a) {
	return {$: 'SetPasswordInModel', a: a};
};
var author$project$Main$viewPasswordInput = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Main$mainContent = function (model) {
	...
	switch (_n0.$) {
		...
		case 'BudgetDetailsPage':
			return A2(author$project$Main$viewBudget, model, author$project$Main$DetailsTab);
		default:
