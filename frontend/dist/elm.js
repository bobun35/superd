...
var _user$my$Constants$loginUrl = 'login';
var _user$my$Constants$homeUrl = 'home';

var _user$my$Msgs$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$my$Msgs$SetPassword = function (a) {
	return {ctor: 'SetPassword', _0: a};
};
var _user$my$Msgs$SetEmail = function (a) {
	return {ctor: 'SetEmail', _0: a};
};
var _user$my$Msgs$SendLogin = {ctor: 'SendLogin'};
var _user$my$Msgs$LoginResponse = function (a) {
	return {ctor: 'LoginResponse', _0: a};
};
var _user$my$Msgs$HomeResponse = function (a) {
...
var _user$my$Types$NotFound = {ctor: 'NotFound'};
var _user$my$Types$Login = {ctor: 'Login'};
		...
		return _elm_lang$http$Http$request(
			{
				...
				headers: {
					ctor: '::',
					_0: _user$my$HomeHelpers$buildSessionHeader(sessionId),
					_1: {ctor: '[]'}
				},
				url: url,
				body: _elm_lang$http$Http$emptyBody,
...
var _user$my$LoginPage$submitLoginButton = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('button is-info is-rounded'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$my$Msgs$SendLogin),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$my$LoginPage$passwordInput = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.userModel.password),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$my$Msgs$SetPassword),
											_1: {ctor: '[]'}
										}
									}
								}
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('fas fa-lock'),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {ctor: '[]'}
...
var _user$my$LoginPage$emailInput = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.userModel.email),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$my$Msgs$SetEmail),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$my$LoginPage$loginPage = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('is-size-1 has-text-link has-text-centered has-text-weight-light padding-bottom'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('la super directrice, c\'est toi !'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$my$LoginPage$emailInput(model),
							_1: {
								ctor: '::',
								_0: _user$my$LoginPage$passwordInput(model),
								_1: {
									ctor: '::',
									_0: _user$my$LoginPage$submitLoginButton,
									_1: {ctor: '[]'}
								}
							}
						}
	...
	function (error, model) {
		...
		return A2(
			...
			message,
			{
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{message: message, messageVisibility: 'visible'}),
				_1: _elm_lang$navigation$Navigation$newUrl('unknown')
			});
	});
var _user$my$UrlHelpers$routeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$my$Types$Login, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$my$Types$Home,
				_evancz$url_parser$UrlParser$s(_user$my$Constants$homeUrl)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$my$Types$Login,
					_evancz$url_parser$UrlParser$s(_user$my$Constants$loginUrl)),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$my$UrlHelpers$decode = function (location) {
	return A2(_evancz$url_parser$UrlParser$parseHash, _user$my$UrlHelpers$routeParser, location);
};
var _user$my$UrlHelpers$urlUpdate = F2(
	function (location, model) {
		var _p0 = _user$my$UrlHelpers$decode(location);
		if (_p0.ctor === 'Nothing') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{page: _user$my$Types$NotFound}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
			return {
...
var _user$my$UrlHelpers$prependHash = function (url) {
	return A2(_elm_lang$core$Basics_ops['++'], '#', url);
};

var _user$my$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'UrlChange':
			...
			case 'LoginResponse':
				if (_p0._0.ctor === 'Ok') {
					...
					return {
						ctor: '_Tuple2',
						_0: updatedModel,
						_1: _user$my$HomeHelpers$sendHomeRequest(updatedModel)
					};
				} else {
					var _p2 = _p0._0._0;
					var _p1 = _p2;
					if (_p1.ctor === 'BadStatus') {
						return _elm_lang$core$Native_Utils.eq(_p1._0.status.code, 401) ? {
							...
							_1: _elm_lang$navigation$Navigation$newUrl(
								_user$my$UrlHelpers$prependHash(_user$my$Constants$loginUrl))
						} : A2(_user$my$UrlHelpers$httpErrorResponse, _p2, model);
					} else {
						return A2(_user$my$UrlHelpers$httpErrorResponse, _p2, model);
					}
				}
			case 'SendLogin':
				return {
			...
			default:
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_0: model,
						_1: _elm_lang$navigation$Navigation$newUrl(
							_user$my$UrlHelpers$prependHash(_user$my$Constants$homeUrl))
					};
				} else {
					var _p4 = _p0._0._0;
					var _p3 = _p4;
					if (_p3.ctor === 'BadStatus') {
						return _elm_lang$core$Native_Utils.eq(_p3._0.status.code, 401) ? {
							ctor: '_Tuple2',
							_0: model,
							_1: _elm_lang$navigation$Navigation$newUrl(
								_user$my$UrlHelpers$prependHash(_user$my$Constants$loginUrl))
						} : A2(_user$my$UrlHelpers$httpErrorResponse, _p4, model);
					} else {
						return A2(_user$my$UrlHelpers$httpErrorResponse, _p4, model);
					}
				}
		}
	});

var _user$my$Views$pageNotFound = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _user$my$Views$pageHome = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$my$Views$mainContent = function (model) {
	var _p0 = model.page;
	switch (_p0.ctor) {
		case 'Home':
			return _user$my$Views$pageHome(model);
		case 'Login':
			return _user$my$LoginPage$loginPage(model);
		default:
			return _user$my$Views$pageNotFound;
	}
};
var _user$my$Views$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$my$Views$mainContent(model),
			_1: {ctor: '[]'}
		});
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$my$Main$main !== 'undefined') {
    _user$my$Main$main(Elm['Main'], 'Main', undefined);
}
