...
data class BudgetSummary(val id: Int,
                         ...
                         val realRemaining: Float = 0.0f, // reste réel (commandes en cours non prise en compte)
                         val virtualRemaining: Float = 0.0f // reste virtuel (commandes en cours déduites)
) {
    companion object {
